        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>They have excellent night vision and can see in just one-sixth the light that humans need.</li>
              <li>A group of cats is called a "clowder".</li>
              <li>Cats spend 70% of their lives sleeping.</li>
              <li>They have 230 bones, which is 24 more than humans.</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Bengal: Wild-looking cats with leopard-like spots or marbling.</li>
